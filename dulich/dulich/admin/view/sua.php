        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div class="container-fluid">
              ...
              <!-- Page Heading -->
              <h1 class="h3 mb-2 text-gray-800">SỬA THÔNG TIN TOUR</h1>
              <!-- DataTales Example -->
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <form action="index.php?action=upDate&id=<?php echo($sp['id']) ?>" method="post" enctype="multipart/form-data">
                      <table class="table table-bordered" id="dataTable" widtd="100%" cellspacing="0">
                      	...
                      	<tbody>
                      		<tr>
                      			<td>Id tour</td>
                      			<td><input type="text" Required="" class="form-control" name="MaT" value="<?php echo($sp['id']) ?>" readonly="" ></td>
                      		</tr>
                      		<tr>
                      			<td>Tên tour</td>
                      			<td><input type="text" Required="" class="form-control" name="TenT" value="<?php echo($sp['ten']) ?>"></td>
                      		</tr>
                      		<tr>
                      			<td>Thời gian</td>
                      			<td><input type="text" Required="" class="form-control" name="Tgian" value="<?php echo($sp['tgian']) ?>"></td>
                      		</tr>
                      		<tr>
                      			<td>Địa điểm</td>
                      			<td><input type="text" Required="" class="form-control" name="Diadiem" value="<?php echo($sp['diadiem']) ?>"></td>
                      		</tr>
                      		<tr>
                      			<td>Khởi hành</td>
                      			<td><input type="text" Required="" class="form-control" name="Khoihanh" value="<?php echo($sp['khoihanh']) ?>"></td>
                      		</tr>
                      		<tr>
                      			<td>Giá tour</td>
                      			<td><input type="text" Required="" class="form-control" name="Gia" value="<?php echo number_format($sp['gia']) ?>"></td>
                      		</tr>
                      		<tr>
                      			<td>
                      				Ảnh thumps
                      			...
                      			<td>
                      				<img src="../<?php echo($sp['anh_thumb']) ?>" width="100px" height="80px">
                      		...
                      		<tr>
                      			<td>Ảnh tour</td>
                      			<td>
                      				<img src="../<?php echo($sp['anh']) ?>" width="100px" height="80px">
                       ...
                       <button type="submit" class="btn btn-info" name="submit">Cập nhập</button>
                      </form>
