	...
	<div class="container-fluid bg-main">
		<div class="container">
			<div class="row head">
				...
				<div class="menu col">
					<div class="home"><a href="http://localhost:81/code/index.php">Trang chủ</a></div>
					<div class="home"><a href="http://localhost:81/code/trangcon/dattour.php">Đặt tour</a></div>
					<div class="home"><a href="http://localhost:81/code/trangcon/amthuc.php">Ẩm thực</a></div>
					<div class="home"><a href="http://localhost:81/code/trangcon/lienhe.php">Liên hệ</a></div>
					...
					<div class="dropdown">
	  					...
	  					<div class="dropdown-menu p-4" aria-labelledby="dangnhapbtn" style="width: 280px;">
	  						<div class="form-group">
	    						...
	    						<input type="email" class="form-control" id="exampleDropdownFormEmail2" placeholder="">
	  						</div>
	  						<div class="form-group">
					        				...
					        				<form action="index.php" method="post" style="margin-left: 30%;">
												<div class="form-group">
											  	...
											  	<div class="form-group">
												    ...
												    <input  type="text" class="form-control" name="tendn"style="width: 400px;">
											  	</div>
											  	<div class="form-group">
												    <label>Mật khẩu</label>
												    <input type="password" class="form-control" name="mk"style="width: 400px;">
											  	</div>
											  	<div class="form-group">
					...
					<div class="modal fade bd-example-modal-xl" id="Dattour" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				    		<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
				    			<div class="modal-content p-0">
					        		...
					        		<div class="modal-body">
					        			<div class="text-justify" style="padding: 3%;">
					        				<form action="index.php?action=dangkitour" method="post" style="margin-left: 30%;">
					        					<?php if(isset($alert)){?>
												...
												<div class="form-group">
											  	...
											  	<div class="d-flex justify-content">
											  		<input type="submit" name="Ghi" class="btn btn-primary" value="Đăng ký đặt tour" >
											  	 </div>
